...
const steps = [
  ...
  },
  {
    ...
    description:
      'Choose the product you like from a huge range of products.',
  },
  {
      ...
      {oneProduct ? (
        <Box className="details">
          <Box className="info-text" >
            ...
            <Button variant="contained" color="success" onClick={() => navigate("/basket")}>
              Buy now!
            </Button>
            <Box style={{ marginLeft: "20px", marginBottom: "20px" }} sx={{ maxWidth: 400 }}>
